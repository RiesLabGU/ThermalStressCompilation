...
hist(ToptAnalysis$Topt_s)
fit1_full <- lmer(Dopt ~ lifestage * absLat + (1|sp), data = ToptAnalysis) #
...
fit_reduced_b <- lmer(maxTDopt ~ lifestage + absLat + (1|sp), data = ToptAnalysis)
...
>>>>>>> 09ba936429b9606fa9e29fbf054851194f8505b3
```{r}
