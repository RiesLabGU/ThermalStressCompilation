...
Interval_table1$lifestage <- factor(Interval_table$lifestage, levels = c("egg", "larva", "pupa", "eggtoemergence"))
...
fit2 <- lmer(Imin ~ lifestage + (1|sp) + (1|family), data = Interval_table) # 
summary(fit2)
Anova(fit2) # 
plot(fit2) #
```
