...
surv_range_vals <- data.frame(set = numeric(), minTemp = numeric(), maxTemp = numeric(), survMid = numeric())
...
surv_range <- function(table){
  ...
  surv_range_vals <- setNames(surv_range_vals, c("set", "minTemp", "maxTemp", "survMid"))
