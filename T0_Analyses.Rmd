...
fit1_red1randomML <- lmer(T0 ~  lifestage + absLat + (lifestage|sp), REML = F, data = as.data.frame(T.set))
summary(fit1_red1randomML)
Anova(fit1_red1randomML)


dw_plot(fit1_red1randomML) +
