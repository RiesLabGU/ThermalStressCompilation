...
T.sets <- T.set %>% 
  select(set)
# write_csv(P.sets,"/Users/marianaabarcazama/Desktop/Projects/ThermalPerformance/sets_Tnot.csv")
```
...
predto <- ggpredict(T0_a_ML, terms = c("absLat","lifestage"))


T0_plot <- ggplot(predto, aes(x = x, y = predicted, colour = group, shape = group)) +
  geom_line()+
