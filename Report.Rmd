...
At the upper thermal ranges contained in the dataset, we are interested in seeing whether we capture the ranges at which survival/development rate begin to decrease. The below code determines whether (Mariana insert). 

## Number of sets where the maximum survival is not at the highest measured temp

## Number of sets where the minimum developmental time is not at the highest measured temp 
