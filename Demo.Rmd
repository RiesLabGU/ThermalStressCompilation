...
scenario2 <- ggplot(seasonal2, aes(x = hr, y = temperature))+
  ...
  geom_text(data = letter, aes(label = "E", y = 40, x = 0.5), size = 4)+
  #geom_line(data = seasonal1, aes(x = hr, y = temperature), col = "orange", alpha = 0.3)+
  #geom_line(data = seasonal2, aes(x = hr, y = temperature), col = "blue", alpha = 0.3)+
  #geom_hline(yintercept  = 23.8, col = "red")+
  # geom_hline(yintercept  = 34.3, col = "red")+
...
B_gdd <- ggplot(GDD_scenario2, aes(x = hr, y = gdh_B_cum/24))+
  ...
  geom_text(data = letter, aes(label = "C", y = 2400, x = 50), size = 4)+
  # annotate("text", x = 200, y = 1900, label = expression(`T`[0]), size = 3)+
  # annotate("text", x = 1000, y = 1900, label = "= 10.5", size = 3)+
  # 
  # annotate("text", x = 200, y = 1700, label = expression(P[high]), size = 3)+
  # annotate("text", x = 1000, y = 1700, label = "= 32.9", size = 3)+
  # 
  # annotate("text", x = 180, y = 1500, label = expression(P[low]), size = 3)+
  # annotate("text", x = 980, y = 1500, label = "= 26.4", size = 3)+
  
  #Scenario 1
  geom_line(data = GDD_scenario1, aes(x = hr, y = gdh_B_cum/24), col =  "#190C3EFF", linetype = 1, alpha = 0.5)+
  geom_line(data = GDD_cap_scenario1_B, aes(x = hr, y = gdh_B_cum/24), linetype = 3, col =  "#190C3EFF")+
  geom_line(data = GDD_scenario2, aes(x = hr, y = 0, col = Beta))+
  
  #Scenario 2
  geom_line(col =  "#E55C30FF", linetype = 1, alpha = 0.5)+
  geom_line(data = GDD_cap_scenario2_B, aes(x = hr, y = gdh_B_cum/24), linetype = 3, col =  "#E55C30FF")+
...
C_gdd <- ggplot(GDD_scenario2, aes(x = hr, y = gdh_C_cum/24))+
  ...
  geom_text(data = letter, aes(label = "D", y = 2500, x = 0.5), size = 4)+
  # annotate("text", x = 200, y = 1900, label = expression(`T`[0]), size = 3)+
  # annotate("text", x = 1000, y = 1900, label = "= 9.3", size = 3)+
  # 
  # annotate("text", x = 200, y = 1700, label = expression(P[high]), size = 3)+
  # annotate("text", x = 1000, y = 1700, label = "= 31.9", size = 3)+
  # 
  # annotate("text", x = 180, y = 1500, label = expression(P[low]), size = 3)+
  # annotate("text", x = 980, y = 1500, label = "= 24.6", size = 3)+
  #Scenario 1
  geom_line(data = GDD_scenario1, aes(x = hr, y = gdh_C_cum/24), col =  "#190C3EFF", linetype = 1, alpha = 0.5)+
  geom_line(data = GDD_cap_scenario1_C, aes(x = hr, y = gdh_C_cum/24), linetype = 3, col =  "#190C3EFF")+
  
  #Scenario 2
  geom_line(col =  "#E55C30FF", linetype = 1, alpha = 0.5)+
  geom_line(data = GDD_cap_scenario2_C, aes(x = hr, y = gdh_C_cum/24), linetype = 3, col =  "#E55C30FF")+
  ylab("")+
  #ylab("Cumulative degree-days")+
  xlab("time (hr)")+
  theme_cowplot()
