...
```{r}
Ana$P <- Ana$s_dr * (Ana$survival/100)
...
6. Calculate Popt (temperature that maximizes performance)
...
Popts: Optimum performance,  Interval_table_cold: lower limit of P-witdh Interval_table_hot: upper limmit of P-witdh Interval_table_both: P-witdh
```{r}
# 
# write_csv(Popt_table,"/Users/marianaabarcazama/Desktop/Projects/ThermalPerformance/Popt.csv")
# write_csv(Popt_table,"/Users/mar/Desktop/Projects/ThermalPerformance/Popt.csv")
# write_csv(Interval_table_cold,"/Users/marianaabarcazama/Desktop/Projects/ThermalPerformance/llP-width.csv")
# write_csv(Interval_table_cold,"/Users/mar/Desktop/Projects/ThermalPerformance/llP-width.csv")
# write_csv(Interval_table_hot,"/Users/marianaabarcazama/Desktop/Projects/ThermalPerformance/ulP-width.csv")
# write_csv(Interval_table_hot,"/Users/mar/Desktop/Projects/ThermalPerformance/ulP-width.csv")
# write_csv(Interval_table_both,"/Users/marianaabarcazama/Desktop/Projects/ThermalPerformance/P-width.csv")
# write_csv(Interval_table_both,"/Users/mar/Desktop/Projects/ThermalPerformance/P-width.csv")

```


Merge performance variables in one table
```{r}
names(Interval_table_cold)
```

```{r}
Popt_to_merge <- Popt_table %>% mutate(Popt = PTopt, performance = Propt) %>% select(-PTopt, -Propt, -Opt)

Merge1 <- select(Interval_table_cold, set, Plower = Imin)
Merge2 <- select(Interval_table_hot, set, Pupper = Imax)
Merge3 <- select(Interval_table_hot, set, Pwidth = Ilength)

Performance1 <- full_join(Popt_to_merge, Merge1, by = "set")
Performance2 <- full_join(Performance1, Merge2, by = "set")
Performance <- full_join(Performance2, Merge3, by = "set")
...
```{r}
# write_csv(Performance,"/Users/marianaabarcazama/Desktop/Projects/ThermalPerformance/Performance.csv")
```
