...
Reduced model: Dopt_s ~  -1 + lifestage + absLat + (1|sp), data = Dopt_table) #
Reduced model's AIC: `r fit1_reduced_aic`, Ngroups = `r fit1_summary$ngrps`, N = `r nrow(Dopt_table)`
...
fit3_summary <- summary(fit3_reduced)
