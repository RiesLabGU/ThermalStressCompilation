...
anova(Dopt_i, Dopt_a, test.statistic = "Chisq") # keep additive model
```
...
predo <- ggpredict(Dopt_a_ML, terms = c("absLat","lifestage"))
...
anova(Dwidth_i, Dwidth_a, test.statistic = "Chisq") # keep additive model
```
...
# Predictions plot
D.set$group <- factor(D.set$lifestage)
predw <- ggpredict(Dwidth_a_ML, terms = c("absLat","lifestage"))


Dwidth_plot <- ggplot(predw, aes(x = x, y = predicted, colour = group, fill = group, shape = group)) +
  geom_line()+
   geom_ribbon(aes(ymin = conf.low, ymax = conf.high, col = group), alpha = 0.1)+
  scale_color_viridis_d()+
  scale_fill_viridis_d()+
...
anova(Dupper_i, Dupper_a, test.statistic = "Chisq") # keep additive model
```
...
# Predictions plot
D.set$group <- factor(D.set$lifestage)
predu <- ggpredict(Dupper_a_ML, terms = c("absLat","lifestage"))


Dupper_plot <- ggplot(predu, aes(x = x, y = predicted, colour = group, fill = group, shape = group)) +
  geom_line()+
   geom_ribbon(aes(ymin = conf.low, ymax = conf.high, col = group), alpha = 0.1)+
  scale_color_viridis_d()+
  scale_fill_viridis_d()+
...
anova(Dlower_i, Dlower_a, test.statistic = "Chisq") # keep additive model
```
...
# Predictions plot
D.set$group <- factor(D.set$lifestage)
predlow <- ggpredict(Dlower_a_ML, terms = c("absLat","lifestage"))



Dlow_plot <- ggplot(predlow, aes(x = x, y = predicted, colour = group, fill = group, shape = group)) +
  geom_line()+
   geom_ribbon(aes(ymin = conf.low, ymax = conf.high, col = group), alpha = 0.1)+
  scale_color_viridis_d()+
  scale_fill_viridis_d()+
  ...
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dlower, col = group), alpha = 0.6)+
  theme_cowplot()+
  theme(legend.title = element_blank(), legend.position = "none")
...
Asses the effect of phylogeny on Dhigh
```{r}
R2(Dhigh_phylo, Dhigh_nophylo) # if this does not work unload and reload rr2
```
...
All development variables in the same plot
```{r}
Dtest1 <- ggplot(predlow, aes(x = x, y = predicted, colour = group, fill = group)) +
  geom_line()+
  geom_line(data = predo, mapping = aes(x = x, y = predicted, colour = group, fill = group))+
  geom_line(data = predu, mapping = aes(x = x, y = predicted, colour = group, fill = group))+
  #geom_ribbon(aes(ymin = conf.low, ymax = conf.high, col = group), alpha = 0.1)+
  scale_color_viridis_d()+
  scale_fill_viridis_d()+
  #scale_shape_manual(values = c(1,16,8))+
 ylab(expression(D[low/opt/high]))+
  xlab("Absolute latitude")+
  ylim(0, 40)+
  annotate("text", x = 0, y = 40, label = "A", size = 5)+
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dlower, col = group), alpha = 0.6, shape =16)+
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dopt, col = group), alpha = 0.6, shape = 1)+
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dupper, col = group), alpha = 0.6, shape = 8)+
  theme_cowplot()+
  theme(legend.title = element_blank(), legend.position = "none")
Dtest1
...
Dtest2 <- ggplot(predlow, aes(x = x, y = predicted, colour = group, fill = group)) +
  geom_line()+
  #geom_line(data = predo, mapping = aes(x = x, y = predicted, colour = group, fill = group))+
  geom_line(data = predu, mapping = aes(x = x, y = predicted, colour = group, fill = group))+
   #geom_ribbon(aes(ymin = conf.low, ymax = conf.high, col = group), alpha = 0.1)+
...
```{r}
Dtest3 <- ggplot(predlow, aes(x = x, y = predicted, colour = group, fill = group)) +
  geom_line()+
  geom_line(data = predo, mapping = aes(x = x, y = predicted), colour = "grey", fill = "grey")+
  geom_line(data = predu, mapping = aes(x = x, y = predicted, colour = group, fill = group))+
   #geom_ribbon(aes(ymin = conf.low, ymax = conf.high, col = group), alpha = 0.1)+
  scale_color_viridis_d()+
  scale_fill_viridis_d()+
  ...
  annotate("text", x = 0, y = 40, label = "A", size = 5)+
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dlower, col = group), alpha = 0.6, shape =16)+
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dopt), alpha = 0.6, col = "grey")+
  geom_point(data = D.set, mapping = aes(x = absLat, y = Dupper, col = group), alpha = 0.6, shape = 8)+
  theme_cowplot()+
  theme(legend.title = element_blank(), legend.position = "none")
Dtest3
