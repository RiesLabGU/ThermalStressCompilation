...
```{r}
ToyData$p1 <- ToyData$dr2 *(ToyData$same/100)
same <- ggplot(ToyData, aes(x = temp, y = p1))+
  geom_line(size = 2, alpha = 0.5, col = "grey", se =F)+ # performance
  geom_line(data = ToyData, mapping = aes(x = temp, y = same/100), size = 2, linetype = 2)+ # survival
  ...
  ylim(-0.25,1)+
  # performance
  geom_segment(x = 20.5, y = -0.08, xend = 34.2, yend = -0.08, linetype = 1)+
  annotate("text", x = 20.5, y = -0.08, label = expression("P"[low]))+
  annotate("text", x = 34.2, y = -0.08, label = expression("P"[high]))+
  
  # development
  geom_segment(x = 20.5, y = 0.51, xend = 34.2, yend = 0.51, linetype = 3)+
  geom_segment(x = 20.5, y = -0.16, xend = 34.2, yend = -0.16, linetype = 1)+
  annotate("text", x = 20.5, y = -0.16, label = expression("D"[low]))+
  annotate("text", x = 34.5, y = -0.16, label = expression("D"[high]))+
  
  
  # survival
  geom_segment(x = 9.5, y = 0.49, xend = 34.5, yend = 0.49, linetype = 2)+
  geom_segment(x = 9.5, y = -0.24, xend = 34.5, yend = -0.24, linetype = 1)+
  annotate("text", x = 9.5, y = -0.24, label = expression("S"[low]))+
  annotate("text", x = 34.5, y = -0.24, label = expression("S"[high]))+
  
  #geom_segment(x = 11, y = 0, xend = 31, yend = 1)+
  #theme(axis.text = element_text(size = 16))
  #theme(axis.text.x= c("Tmin", "T0", "Topt", "Tmax"))+
  annotate("rect", xmin = 20.5, xmax = 34.2, ymin = -Inf, ymax = 1, fill = "grey", alpha = 0.3)+
 
  
  
  scale_x_continuous(breaks = c(9.5, 27, 39.5), labels = c("chill stress", "optimal range", "heat stress"))+
  theme(axis.ticks.x = element_blank())
#scale_x_continuous(breaks = c( 20.5, 34.2), labels = c( expression("P"[low]), expression("P"[high])))
same
...
dhigher <- ggplot(ToyData, aes(x = temp, y = p2))+
  geom_line(size = 2, alpha = 0.5, col = "grey")+ # performance
  geom_line(data = ToyData, mapping = aes(x = temp, y = shigher/100), size = 2, linetype = 2)+ # survival
  geom_line(data = ToyData, mapping = aes(x = temp, y = dr2), size = 2, col = "black", linetype = 3)+ #development rate
 # performance
  geom_segment(x = 20.5, y = -0.08, xend = 34.2, yend = -0.08, linetype = 1)+
  ...
  # survival
  geom_segment(x = 9.5, y = 0.49, xend = 34.5, yend = 0.49, linetype = 2)+
  geom_segment(x = 9.5, y = -0.24, xend = 39, yend = -0.24, linetype = 1)+
...
dlower <- ggplot(ToyData, aes(x = temp, y = p3))+
  ...
  geom_line(data = ToyData, mapping = aes(x = temp, y = slower/100), size = 2, linetype = 2)+ # survival
  geom_line(data = ToyData, mapping = aes(x = temp, y = dr2), size = 2, col = "black", linetype = 3)+ #development rate
  #geom_smooth(data = ToyData, mapping = aes(x = temp, y = survival2/100), size = 2, linetype = 2, se = F, col = "black")+
  theme_cowplot()+
  ...
  ylim(-0.25,1)+
  # performance
  geom_segment(x = 20.5, y = -0.08, xend = 32, yend = -0.08, linetype = 1)+
  annotate("text", x = 19.5, y = -0.08, label = expression("P"[low]))+
  ...
  # survival
  geom_segment(x = 9.5, y = 0.49, xend = 32, yend = 0.49, linetype = 2)+
  geom_segment(x = 9.5, y = -0.24, xend = 32, yend = -0.24, linetype = 1)+
  annotate("text", x = 8.5, y = -0.24, label = expression("S"[low]))+
