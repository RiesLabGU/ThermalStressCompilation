...
devrate <- ggplot(Figure1, aes(x = temperature, y = tropical))+
  ...
  geom_point(Dhigh, mapping = aes(x = 14.5, y = 0), size = 4, shape = 1)+
...
per1 <- ggplot(Figure1, aes(x = temperature, y = tropical))+
  ...
  #theme(axis.text.x=element_blank())+
  #theme(axis.text.x= c("T0", "D-low", "D-opt", "D-high"))+
  scale_x_continuous(breaks = c(31, 36), labels = c(expression("D/P"[opt]), expression("S"[opt])))
...
per3 <- ggplot(Figure1, aes(x = temperature, y = d3))+
 ...
 # xlim(10,30)+
  ...
  #theme(axis.text.x=element_blank())+
  #theme(axis.text.x= c("T0", "D-low", "D-opt", "D-high"))+
  scale_x_continuous(limits = c(10,33),breaks = c(31, 27), labels = c( expression("D"[opt]),  expression("S/P"[opt])))
per3
```
