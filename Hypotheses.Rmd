...
```{r}
widthlat <- ggplot(hyp, aes(x = Shigh, y = Dhigh))+
  geom_line(size = 2)+
  theme_cowplot()+
  annotate("text", x = 28.5, y = 36, label = "E", size = 5)+
...
threelat <-  ggplot(hyp, aes(x = Dopt, y = Sopt))+
  ...
  geom_segment(x = 26, xend = 34, y = 34, yend = 26, size = 2)+
  #geom_segment(x = 2, xend = 31, y = 0, yend = 1, col = "black")+
  theme_cowplot()+
  annotate("text", x = 25, y = 35, label = "D", size = 5)+
  ylab(lab)+
  xlab("Absolute latitude")+
  ylim(25, 35)+
  xlim(25, 35)+
...
```{r}
inset <- ggplot(Figure1, aes(x = temperature, y = P2))+
...
Large skew
```{r}
inset2 <- ggplot(Figure1, aes(x = temperature, y = P2))+
  geom_line(size = 3, col = "grey")+
  geom_segment(x = 31, xend = 31, y = 0, yend = 1, col = "black")+ # opt line
  geom_point(x = 31, y = 1, col = "black")+ # opt line
  geom_segment(x = 23, xend = 31, y = 0.5, yend = 0.5,linetype = 1, col = "grey35", size = 2)+ # cold tolerance (9)
