...
devesur <- ggplot(ToyData, aes(x = temp, y = dr))+
  ...
  geom_line(data = ToyData, mapping = aes(x = temp, y = same/100), size = 2, col = "black", linetype = 2)+
...
same <- ggplot(ToyData, aes(x = temp, y = p1))+
  ...
  xlab("Temperature")+
  ylim(-0.08,1)+
  #geom_segment(x = 20.5, y = 0.5, xend = 34.5, yend = 0.5, linetype = 1, size = 2, col = "grey")+
  ...
  annotate("text", x = 9.5, y = -0.08, label = "chill stress")+
  annotate("text", x = 39.5, y = -0.08, label = "heat stress")+
  annotate("text", x = 27, y = -0.08, label = "optimal range")+
...
dlower <- ggplot(ToyData, aes(x = temp, y = p3))+
  ...
  #theme(axis.text = element_text(size = 16))
  #theme(axis.text.x= c("Tmin", "T0", "Topt", "Tmax"))+
  annotate("rect", xmin = 20.5, xmax = 32, ymin = -Inf, ymax = 1, fill = "grey", alpha = 0.3)+
  annotate("text", x = 9.5, y = -0.08, label = "chill stress")+
  annotate("text", x = 39.5, y = -0.08, label = "heat stress")+
  annotate("text", x = 26, y = -0.08, label = "optimal range")+
  ...
  #scale_x_continuous(breaks = c(8, 11, 31, 36), labels = c(expression("T"[min]), expression("T"[0]), expression("T"[opt]), expression("T"[high])))
  #scale_x_continuous(breaks = c(9.5, 20.5, 34.2, 39.5), labels = c("chill stress", expression("P"[low]), expression("P"[high]), "heat stress"))
  scale_x_continuous(breaks = c( 20.5, 32), labels = c( expression("P"[low]), expression("P"[high])))
dlower
