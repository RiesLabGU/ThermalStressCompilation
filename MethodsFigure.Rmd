...
Figure1D <- ggplot(data = set_w,aes(x = temp, y = P*18)) + 
  geom_line()+
  geom_point(data = set_w, mapping = aes(x = temp, y = survival/100), shape = 2, col= "grey39")+
  geom_point(data = set_w, mapping = aes(x = temp, y = dr*18), col = "darkgrey")+
  geom_line(data = set_w, mapping = aes(x = temp, y = survival/100), linetype = 2, col = "grey39")+
  geom_line(data = set_w, mapping = aes(x = temp, y = dr*18),linetype = 2, col = "darkgrey")+
  
  geom_segment(x = P_min, xend = PTopt, y = P50*18, yend = P50*18,linetype = 3)+
  #geom_text(data = label_sub, aes(x = temp, y = P + 0.01,label ="sub-Popt"))+
  
  geom_segment(x = PTopt, xend = P_max, y = P50*18, yend = P50*18, linetype = 3)+
  #geom_text(data = label_supra, aes(x = temp, y = P +.01,label ="supra\nPopt"))+
  geom_text(data = label_sub, aes(x = temp-5, y = P - .05,label ="P-interval"))+
