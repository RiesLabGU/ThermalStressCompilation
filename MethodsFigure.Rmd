...
P-interval: interval of temperatures permiting performance of >= 50% 
...
Figure1A <- ggplot(data = predicted, aes(x = temp, y = dr)) + 
  ...
  geom_text(data = label_text1, aes(x = x-4, y = (y/2)-0.002 ,label ="D-interval"))+
  ...
  #geom_segment(x = dTopt, xend = sub_max, y = d_50, yend = d_50, linetype = 2)+
   #ylim(0, 0.35)+
  geom_text(data = label_text1, mapping = (aes(x = x-3, y = y ,label ="Dopt")))+
   xlim(5, 43)+
  theme_cowplot()+
...
Figure1B <- ggplot(data = linear_3, aes(x = temp, y = dr)) + 
  ...
  geom_point(data = set_w, mapping = aes(x = temp, y = dr), shape = 1)+
   geom_text(data = text, aes(x = temp-5, y = 0, label = paste("T0 =",round(t0, digits = 2), sep = " ")))+
...
Figure1C <- ggplot(data = set_w,aes(x = temp, y = survival/100)) + 
  ...
  theme_cowplot()+
  geom_text(data = label_text, aes(x = x -7, y = y ,label ="S-interval"))+
  geom_text(data = label_text, aes(x = x - 16 , y = y + 0.4 ,label ="minSopt"))+
  geom_text(data = label_text, aes(x = x -2, y = y + 0.4 ,label ="maxSopt"))+
  #ylim(0, 0.35)+
   xlim(5, 43)+
...
Figure1D <- ggplot(data = set_w,aes(x = temp, y = P*30)) + 
  geom_line()+
  geom_point(data = set_w, mapping = aes(x = temp, y = survival/100), shape = 2, col= "grey39")+
  geom_point(data = set_w, mapping = aes(x = temp, y = dr*30), col = "darkgrey")+
  geom_line(data = set_w, mapping = aes(x = temp, y = survival/100), linetype = 2, col = "grey39")+
  geom_line(data = set_w, mapping = aes(x = temp, y = dr*30),linetype = 2, col = "darkgrey")+
  
  geom_segment(x = P_min, xend = PTopt, y = P50*30, yend = P50*30,linetype = 3)+
  #geom_text(data = label_sub, aes(x = temp, y = P + 0.01,label ="sub-Popt"))+
  
  geom_segment(x = PTopt, xend = P_max, y = P50*30, yend = P50*30, linetype = 3)+
  ...
  geom_point(x  = PTopt, y = P_opt*3)+
  geom_text(data = PoptPoint-2, aes(x = temp-3, y = 0.75,label ="Popt"))+
  
  scale_y_continuous(sec.axis = sec_axis(~./30, name = "P, Development rate"))+
   #ylim(0, 0.35)+
   xlim(5, 43)+
  labs(x = "Temperature", y = "Survival")
Figure1D
