...
Figure1B <- ggplot(data = predicted, aes(x = temp, y = dr)) + 
  ...
  geom_text(data = label_text1, aes(x = x + 7.5, y = y ,label ="Development\n interval"))+
...
Figure1C <- ggplot(data = set_w,aes(x = temp, y = survival/100)) + 
  ...
  theme_cowplot()+
  geom_text(data = label_text, aes(x = x, y = y ,label ="Survival interval"))+
...
Figure1D <- ggplot(data = set_w,aes(x = temp, y = P/0.4)) + 
  ...
  geom_text(data = label_sub, aes(x = temp + 4, y = P - .15,label ="Performance \n interval"))+
